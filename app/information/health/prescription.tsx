...
export default function PrescriptionInfo() {
  ...
  const tiles = [
    {
      key: 'how_to_get',
      icon: <MaterialIcons name="description" size={24} color="#3B82F6" />,
    ...
    {
      key: 'required_meds',
      icon: <MaterialIcons name="local-pharmacy" size={24} color="#DC2626" />,
    ...
    },
    {
      ...
      icon: <MaterialIcons name="payment" size={24} color="#059669" />,
    ...
    },
    {
      ...
      icon: <MaterialIcons name="shopping-cart" size={24} color="#7C3AED" />,
    ...
    },
    {
      ...
      icon: <MaterialIcons name="assignment" size={24} color="#0891B2" />,
    ...
    },
    {
      ...
      icon: <MaterialIcons name="help-outline" size={24} color="#EA580C" />,
