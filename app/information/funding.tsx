...
const fundingTiles: FundingTile[] = [
  {
  ...
  {
    id: 'educational-subsidies',
    title: { en: 'Educational Subsidies', de: 'Bildungsförderungen' },
    color: '#10B981',
    icon: '🎓'
  },
  {
    id: 'living-subsidies',
    title: { en: 'Living Subsidies', de: 'Lebensunterhaltsförderungen' },
    color: '#F59E0B',
    icon: '🏠'
  },
  {
    id: 'housing-subsidies',
    title: { en: 'Housing Subsidies', de: 'Wohnförderungen' },
    color: '#EF4444',
    icon: '🏘️'
  },
  {
  ...
  },
  {
    ...
    title: { en: 'Application Process', de: 'Antragsprozess' },
    color: '#F97316',
    icon: '📝'
  }
];
...
const FundingPage: React.FC = () => {
  ...
  const handleTilePress = (tileId: string) => {
    ...
    router.push(`/information/funding/${tileId}`);
  };
  ...
  const renderTile = ({ item }: { item: FundingTile }) => (
    <TouchableOpacity 
