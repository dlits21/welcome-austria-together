...
import educationEntitiesData from '../../../data/information/education.json';

const DynamicEducationPage: React.FC = () => {
  ...
  const entity = educationEntitiesData.entities.find(
...
export default DynamicEducationPage;
