...
const Translation: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zu Übersetzungsdiensten und Sprachunterstützung in Österreich.'
        : 'On this page, you will find information about translation services and language support in Austria.'}
    </div>
  );
