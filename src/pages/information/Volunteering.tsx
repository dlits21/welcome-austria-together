...
const Volunteering: React.FC = () => {
  ...
  const pageDescription = language.code === 'de' 
    ? 'Möglichkeiten zur Freiwilligenarbeit, anderen zu helfen und zur Gemeinschaft beizutragen.'
    : 'Opportunities to volunteer, help others, and contribute to your community.';

  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zu Freiwilligenarbeit in Österreich.'
        : 'On this page, you will find information about volunteering in Austria.'}
    </div>
  );
