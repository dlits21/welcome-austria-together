...
const Finance: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zu Finanzen und Bankwesen in Österreich.'
        : 'On this page, you will find information about finance and banking in Austria.'}
    </div>
  );
