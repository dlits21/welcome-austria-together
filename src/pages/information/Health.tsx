...
const Health: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zum Gesundheitssystem in Österreich.'
        : 'On this page, you will find information about the healthcare system in Austria.'}
    </div>
  );
