...
const Contacts: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie wichtige Kontakte und Informationen zur rechtlichen Unterstützung in Österreich.'
        : 'On this page, you will find important contacts and information about legal support in Austria.'}
    </div>
  );
