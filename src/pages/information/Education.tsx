...
const Education: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zu Bildung und Kinderbetreuung in Österreich.'
        : 'On this page, you will find information about education and childcare in Austria.'}
    </div>
  );
