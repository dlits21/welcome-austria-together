...
const Culture: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zu Kultur und Freizeitangeboten in Österreich.'
        : 'On this page, you will find information about culture and leisure opportunities in Austria.'}
    </div>
  );
