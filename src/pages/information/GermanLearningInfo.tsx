...
const GermanLearningInfo: React.FC = () => {
  ...
  const helpContent = (
    <div>
      {language.code === 'de' 
        ? 'Auf dieser Seite finden Sie Informationen zum Deutschlernen in Österreich.'
        : 'On this page, you will find information about learning German in Austria.'}
    </div>
  );
...
export default GermanLearningInfo;
