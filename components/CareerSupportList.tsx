...
const CareerSupportList: React.FC<CareerSupportListProps> = ({
  ...
  const [filteredEntities, setFilteredEntities] = useState<CareerEntity[]>([]);

  useEffect(() => {
    let filtered = careerEntities.entities as CareerEntity[];
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        {filteredEntities.map((entity) => (
          <TouchableOpacity
            ...
            onPress={() => router.push(`/ask/career/${entity.id}`)}
          >
